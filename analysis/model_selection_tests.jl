...
training = dat_states[dat_states.PERIOD .<= 54,:]
...
compare_models(training,X,init,covars_sets,tau_grid,regularzation_grid, n_per_fold_inner, k_folds_inner;
                save_results = true, path_to_results = "results/cross_validation_tests",
                file_tag = "$(model_type)_$(site)")